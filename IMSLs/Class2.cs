...
public class Plannar_fit : NonlinearRegression.IFunction
{
    ...
    public double ComputeE(Single[] xd, double[] teta)
    {
        ...
        E = xd[0] * teta[0] + xd[1] * teta[1] + teta[2];
    ...
    public double[] Main(Single[] vx, Single[] vy, double scal, double tol)
    {
        ...
        NonlinearRegression.IFunction fcn = new Plannar_fit();
        // GenerateData();
